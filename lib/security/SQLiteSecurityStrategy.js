...
exports.getRoles=function() {
    ...
    DB.query(LOG.show(MODULE,CONFIG.ROLE_SQL)).then(function(data){
...
exports.login=function(credentials) {
    LOG.info(MODULE,'Processing login request for user:',credentials.username);
    var promise= Q.defer();
        DB.query(LOG.show(MODULE,UTIL.format(CONFIG.LOGIN_SQL||CONST_LOGIN_QUERY,credentials.username,credentials.password))).then(function(data){
